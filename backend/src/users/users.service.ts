...
//1) Kullanıcı tüm bilgilerini görebilcek ; İsim, e-posta, şifre, 
//2)Kullanıcı satın aldığı hizmetlere erişebilecek.
//3)Kullanıcı kişisel bilgilerini güncelleyebilecek
@Injectable()
