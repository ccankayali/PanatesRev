          ...
          <button className="flex items-center">
            <span className="relative flex-shrink-0">
              <img
                ...
                src="https://media.licdn.com/dms/image/D4D03AQG30rrjPhv4FA/profile-displayphoto-shrink_800_800/0/1694514652576?e=2147483647&v=beta&t=1o9io4y14ZhxCxvnuG-JQ-ThYnG1-viA3EBb5fCAVBM"
                alt="profile"
              />
            ...
            <span className="ml-2">Görkem Kurtkaya</span>
            <svg
              viewBox="0 0 24 24"
                ...
                <tr>
                  ...
                  <td className="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800">
                    <div className="flex items-center">
                      <div className="sm:flex hidden flex-col">
                        24.12.2020
                        <div className="text-gray-400 text-xs">11:03 AM</div>
                      </div>
                      <button className="w-8 h-8 inline-flex items-center justify-center text-gray-400 ml-auto">
                        <svg
                          viewBox="0 0 24 24"
